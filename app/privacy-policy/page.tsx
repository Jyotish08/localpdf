    ...
    <AppShell>
      <main className="mx-auto w-full max-w-3xl flex-1 px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        ...
        <div className="rounded-3xl border border-border bg-card p-6 shadow-sm sm:p-10 space-y-10 text-muted leading-relaxed">
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">2. Data Collection</h2>
          ...
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">5. Third-Party Services &amp; Advertising</h2>
            ...
            <p className="mb-3">You may opt out of personalised advertising at <a href="https://adssettings.google.com" target="_blank" rel="noopener noreferrer" className="text-accent underline hover:text-accent/80">adssettings.google.com</a>. For more information see <a href="https://policies.google.com/technologies/partner-sites" target="_blank" rel="noopener noreferrer" className="text-accent underline hover:text-accent/80">Google&apos;s Privacy &amp; Terms</a>.</p>
          </section>
          <section>
            <h2 className="text-xl font-bold text-foreground mb-3">6. Children&apos;s Privacy</h2>
          ...
          <section>
            ...
            <p>Questions about this policy? Contact us at <a href="mailto:privacy@pdftools.app" className="font-semibold text-accent hover:underline">privacy@pdftools.app</a></p>
          </section>
        </div>
      </main>
    </AppShell>
