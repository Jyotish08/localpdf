      ...
      <main className="flex-1 px-4 py-12 sm:px-6 sm:py-16 lg:px-8">
        <div className="mx-auto max-w-3xl">
          ...
          <div className="rounded-2xl border border-slate-200 bg-white p-6 shadow-sm sm:p-10 space-y-10 text-slate-700 leading-relaxed">
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 mb-3">4. No Liability for File Loss or Corruption</h2>
            ...
            <section>
              <h2 className="text-xl font-bold text-slate-900 mb-3">7. Privacy</h2>
              <p>Your use of the Service is also governed by our <a href="/privacy-policy" className="text-teal-600 underline hover:text-teal-700">Privacy Policy</a>, which is incorporated into these Terms by reference. Because all file processing is done locally in your browser, PDFTools does not have access to your files or their contents.</p>
            </section>
            ...
            <section>
              ...
              <p>If you have questions about these Terms, please contact us at <a href="mailto:legal@pdftools.app" className="font-semibold text-teal-600 hover:underline">legal@pdftools.app</a></p>
            </section>
          </div>
        </div>
      </main>
